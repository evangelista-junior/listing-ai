...
export function Hero() {
  return (
    <section className="relative mx-auto py-18 px-3 sm:px-3 lg:px-6 overflow-hidden">
      <div className="relative max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-center items-center text-center mb-15">
          ...
          <div className="relative mx-auto animate-fade-in stagger-3">
            ...
            <div className="relative max-w-11/12 mx-auto bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden">
              ...
              <div className="absolute top-2 right-3 bg-linear-to-r from-primary to-auxiliar text-white px-3 py-1 rounded-full flex items-center gap-2 shadow-lg">
