...
export default function DashboardPage() {
  ...
  const SortIcon = ({ field }: { field: SortField }) => {
    ...
    if (sortDirection === "asc") {
      return <ArrowUp className="w-4 h-4 text-[#2563EB]" />;
    }
    ...
    <div className="max-w-7xl mx-auto">
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="flex items-center text-sm font-medium text-[#10B981]">
                  {stat.change}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <h2 className="text-xl font-bold text-[#0F172A]">Recent Listings</h2>
        ...
        {/* Bulk Actions Bar */}
        {isSomeSelected && (
          <div className="px-6 py-4 bg-linear-to-r from-[#2563EB] to-[#22D3EE] flex items-center justify-between">
            <div className="flex items-center gap-3">
